...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-bad':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('GF_assets_bad');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gf-iphone':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('GF_assets_iphone');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'monster':
				...
				playAnim('idle');
			case 'monster-iphone':
				tex = Paths.getSparrowAtlas('Monster_No_iphone');
				frames = tex;
				animation.addByPrefix('idle', 'monster idle', 24, false);
				animation.addByPrefix('singUP', 'monster up note', 24, false);
				animation.addByPrefix('singDOWN', 'monster down', 24, false);
			...
			case 'pico':
				...
				flipX = true;
			case 'pico-bad':
				tex = Paths.getSparrowAtlas('Pico_bad');
				frames = tex;
				animation.addByPrefix('idle', "Pico Idle Dance", 24);
				animation.addByPrefix('singUP', 'pico Up note0', 24, false);
				animation.addByPrefix('singDOWN', 'Pico Down Note0', 24, false);
			...
			case 'bf-car':
				...
				flipX = true;
			case 'bf-bad':
				var tex = Paths.getSparrowAtlas('BOYFRIENDbad');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				flipX = true;
			case 'bf-pixel':
				var tex = Paths.getSparrowAtlas('weeb/BOYFRIENDgreymiss');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'bf-pixel2':
				...
				flipX = true;
			case 'bf-pixel-dead':
				frames = Paths.getSparrowAtlas('weeb/bf_pixel_dead');
			...
			case 'senpai':
				...
				addOffset("singLEFT",-13, 5);
				addOffset("singDOWN",4 ,8);
				...
				updateHitbox();
			case 'senpai-pixel':
				frames = Paths.getSparrowAtlas('weeb/senpai_pixel');
			...
			case 'senpai-angry':
				...
				addOffset('idle');
				addOffset('singUP',5, -2);
				addOffset("singRIGHT",-26, -2);
				addOffset("singLEFT",-14, 3);
				addOffset("singDOWN",5 ,8);
				playAnim('idle');

				setGraphicSize(Std.int(width * 1.12));
				updateHitbox();
			case 'spirit':
				frames = Paths.getSparrowAtlas('weeb/spirit');
				animation.addByPrefix('idle', "idle spirit", 24, false);
				animation.addByPrefix('singUP', "up", 24, false);
				animation.addByPrefix('singRIGHT', "right", 24, false);
				animation.addByPrefix('singLEFT', "left", 24, false);
				...
				updateHitbox();
			case 'spirit-template':
				frames = Paths.getSparrowAtlas('weeb/spirit_template');
				animation.addByPrefix('idle', "idle spirit", 24, false);
				animation.addByPrefix('singUP', "up", 24, false);
				animation.addByPrefix('singRIGHT', "right", 24, false);
				animation.addByPrefix('singLEFT', "left", 24, false);
				...
				updateHitbox();
			case 'spirit-pixel':
				frames = Paths.getPackerAtlas('weeb/spirit_pixel');
	...
	public function playAnim(AnimName:String, Force:Bool = false, Reversed:Bool = false, Frame:Int = 0):Void
	{
		...
		if (curCharacter == 'gf' || curCharacter == 'gf-bad')
		{
